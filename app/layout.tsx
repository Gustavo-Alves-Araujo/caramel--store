...
export const metadata: Metadata = {
  title: "Caramelô - Carrinho de Pipoca Retrô para Eventos",
  description: "O sabor da nostalgia em cada evento. Carrinhos de pipoca retrô, picolé artesanal e algodão doce para transformar sua festa em uma experiência única.",
    generator: 'v0.app'
}
