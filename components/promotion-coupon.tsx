  ...
  return (
    <>
      <section className="py-8 bg-gradient-to-r from-coffee-dark via-coffee-medium to-coffee-dark relative overflow-hidden">
        ...
        >
          <motion.div
            className="bg-gradient-to-r from-coffee-dark/90 to-coffee-medium/90 rounded-xl p-1 shadow-2xl cursor-pointer"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            onClick={() => setIsOpen(true)}
          >
            <div className="bg-cream rounded-lg p-6 md:p-8 flex flex-col md:flex-row items-center justify-between relative overflow-hidden">
              {/* Decorative elements */}
              ...
              <div className="flex-1 text-center md:text-left mb-4 md:mb-0">
                <div className="flex items-center justify-center md:justify-start gap-2 mb-2">
                  ...
                  <span className="text-coffee-dark font-bold uppercase tracking-wider text-sm">Oferta Especial</span>
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-coffee-dark mb-2">
                  Ganhe <span className="text-coffee-dark">10% OFF</span> no seu primeiro evento!
                </h2>
                <p className="text-coffee-dark/80 max-w-2xl">
              ...
              <div className="flex-shrink-0">
                <Button className="bg-coffee-dark hover:bg-coffee-dark/90 text- font-bold px-6 py-6 h-auto shadow-lg">
                  RESGATAR CUPOM
          ...
          {isSubmitted ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-6">
                Seu cupom de desconto será enviado por WhatsApp ou e-mail em breve. Nossa equipe entrará em contato para confirmar os detalhes!
              </p>
              <Button
