...
export default function AllProducts() {
  ...
  return (
    <section
      id="products"
      className="py-24 bg-gradient-to-b from-white to-cream relative"
    >
        ...
        <div className="text-center mb-16" ref={ref}>
          ...
          >
            <p className="text-muted-foreground max-w-3xl mx-auto font-lora text-xl mt-6">
              Escolha entre nossos carrinhos retrô e transforme seu evento em
              uma experiência única. Entre em contato hoje mesmo para solicitar
          ...
          >
            <div className="p-8 md:p-12 flex flex-col justify-center items-center text-center relative">
              ...
              <p className="text-coffee-dark/80 font-lora text-lg md:text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
                Quer combinar mais de um carrinho ou tem alguma necessidade
                específica? Entre em contato conosco para criar um pacote
                personalizado que atenda perfeitamente às necessidades do seu
                evento.
              </p>
