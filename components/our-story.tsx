      ...
      <div className="container px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <h2 className="text-5xl md:text-6xl font-bold mb-6 relative z-10 text-coffee-dark">
            ...
            >
              <p className="text-coffee-dark mb-6 font-lora text-xl leading-relaxed">
                A Caramelô nasceu da vontade de transformar momentos em memórias doces.
                E o nosso símbolo o "C" com a gota de caramelo, é a expressão mais pura desse sentimento.
              </p>
              <p className="text-coffee-dark mb-6 font-lora text-xl leading-relaxed">
                O "C" representa o círculo da vida, o movimento que conecta pessoas, histórias e sabores.
                A gota dourada é o nosso toque especial: o caramelo que escorre com leveza, lembrando que o simples também pode ser extraordinário.
              </p>
              <p className="text-coffee-dark mb-6 font-lora text-xl leading-relaxed">
                Cada traço foi pensado para transmitir calma, carinho e elegância.
                É mais do que uma marca é uma emoção desenhada.
              </p>
              <p className="text-coffee-dark mb-8 font-lora text-xl leading-relaxed">
                Caramelô<br />
                Mais do que um serviço, oferecemos memórias doces.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10 shadow-lg">
                ...
                <span className="text-coffee-dark font-medium">Experiência comprovada</span>
              </div>
            </motion.div>
          ...
          >
            ...
            >
              <Image
                ...
                width={400}
                height={500}
                className="object-cover bg-white w-full h-auto rounded-lg"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end">
                <div className="p-6 text-white">
                  <h3 className="font-bold text-xl">Caramelô</h3>
                  <p className="text-sm">O sabor da nostalgia em cada evento</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
