    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled || pathname.includes("/product-page")
          ? "bg-cream/95 backdrop-blur-md py-2 shadow-md"
          : "bg-transparent py-4"
      }`}
    >
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
                ...
                className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                  isActive(link.href) 
                    ...
                    : isScrolled || pathname.includes("/product-page")
                      ...
                      : "text-white hover:text-gold drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]"
                }`}
              >
                {link.label}
              </button>
          ...
          <div className="md:hidden">
            <Button
              ...
              className="text-coffee-dark hover:text-gold hover:bg-transparent"
            >
                  ...
                  <Link
                    ...
                    className={`px-3 py-2 rounded-md text-base font-medium transition-colors ${
                      isActive(link.href)
                        ...
                        : "text-coffee-dark hover:text-gold hover:bg-coffee-dark/30"
                    }`}
                  >
                    {link.label}
                  </Link>
